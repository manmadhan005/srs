...
const ViewLeaves = () => {
 ...
 <Link to="/add" className="btn-add-leave">Apply for Leave</Link>
 </div>
 ...
 <div className="leaves-grid">
  ...
  <Link to={`/update/${leave.id}`} className="btn-action btn-edit">Edit</Link>
 ...
 <div className="no-leaves-container">
  ...
  <Link to="/add" className="btn-add-leave">Create a New Request</Link>
 </div>
 )}
 </div>
 );
